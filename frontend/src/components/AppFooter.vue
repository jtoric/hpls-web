<template>
  <footer class="bg-[#2471a3] text-white py-10 px-4">
    <div class="max-w-4xl mx-auto text-center">
      <div class="mb-6">
        <span class="text-3xl font-extrabold tracking-wider text-[#f1c40f]">HPLS</span>
      </div>
      ...
      <div class="space-y-2 text-white/90 mb-6">
        ...
        <p><strong>IBAN:</strong> HR1023600011102577559</p>
        <p>
          <strong>E-mail:</strong>
          <a href="mailto:hrvatskipowerliftingsavez.2012@gmail.com" class="underline hover:text-white">
            hrvatskipowerliftingsavez.2012@gmail.com
          </a>
        </p>
      </div>
      ...
      <div class="flex items-center justify-center gap-6 mb-8">
        ...
        <a href="https://instagram.com" target="_blank" rel="noopener" class="flex items-center gap-2 text-white/80 hover:text-white transition-colors">
